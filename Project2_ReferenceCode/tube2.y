...
%token <lexeme> VALUE TYPE ID COMMAND_PRINT COMMAND_RANDOM
...
%type <ast_node> expression declaration statement statement_list var_usage var_declare command argument_list
...
expression:  expression '+' expression { 
	...
	|    var_usage { $$ = $1; }
        |    COMMAND_RANDOM '(' expression ')' {
               $$ = new ASTNode_Math1_Minus($3);  // NOTE: NOT CORRECT!  FIX!!
             }
